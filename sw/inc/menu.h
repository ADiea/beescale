...
const char MT_SCALE_SCALE[] PROGMEM   = "Scale";
const char MT_SCALE_START[] PROGMEM   = "Start";
const char MT_SCALE_DOWN[] PROGMEM   = "Download";
const char MT_SCALE_FORMAT[] PROGMEM   = "Format";

const MENU_NEXTSTATE menu_nextstate[] PROGMEM = {
//  STATE                       INPUT       NEXT STATE

    {ST_TIME,                   KEY_PLUS,   ST_SCALE},
    ...
    {ST_OPTIONS_POWER_SAVE,       KEY_PLUS,     ST_OPTIONS_DISPLAY},
	...
	{ST_SCALE,         KEY_PLUS,     ST_OPTIONS},
    {ST_SCALE,         KEY_NEXT,     ST_SCALE_START},
    {ST_SCALE,         KEY_MINUS,    ST_TIME},
	
	{ST_SCALE_START,         KEY_PLUS,     ST_SCALE_FORMAT},
    {ST_SCALE_START,         KEY_NEXT,     ST_SCALE_WORKING},
	{ST_SCALE_START,  		 KEY_PREV,     ST_SCALE},
    {ST_SCALE_START,         KEY_MINUS,    ST_SCALE_DOWN},
	
	{ST_SCALE_DOWN,         KEY_PLUS,     ST_SCALE_START},
    {ST_SCALE_DOWN,         KEY_NEXT,     ST_SCALE_DOWN_FUNC},
	{ST_SCALE_DOWN,  		 KEY_PREV,     ST_SCALE},
    {ST_SCALE_DOWN,         KEY_MINUS,    ST_SCALE_FORMAT},
	
	{ST_SCALE_FORMAT,         KEY_PLUS,     ST_SCALE_DOWN},
    {ST_SCALE_FORMAT,         KEY_NEXT,     ST_SCALE_FORMAT_FUNC},
	{ST_SCALE_FORMAT,  		 KEY_PREV,     ST_SCALE},
    {ST_SCALE_FORMAT,         KEY_MINUS,    ST_SCALE_START},
...
//  STATE                               STATE TEXT                  STATE_FUNC
	...
	{ST_SCALE, 							MT_SCALE_SCALE, 			NULL},
	{ST_SCALE_START, 					MT_SCALE_START, 			NULL},
	{ST_SCALE_DOWN, 					MT_SCALE_DOWN,				NULL},
	{ST_SCALE_DOWN_FUNC, 				NULL, 						StateScaleDownload},
	{ST_SCALE_FORMAT, 					MT_SCALE_FORMAT, 			NULL},
	{ST_SCALE_FORMAT_FUNC,				NULL, 						StateScaleFormat},
	{ST_SCALE_WORKING, 					NULL, 						StateScaleAutoMeasureFunc},
